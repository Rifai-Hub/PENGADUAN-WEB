...
<!-- Pembuka Head -->
<!-- asset digunakan untuk mendefinisikan folder "public" -->
<!-- kita ngambil dari folder baru, yaitu di dalam "public" di dalam "css"  -->
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© Rifai Gusnian | All Rights Reserved</p>
    </div>
</div>
...
{{-- Modal --}}
<div class="modal flade" id="loginModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
